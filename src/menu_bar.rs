...
fn MenuItem(
    ...
    view! {
        <div class=class on:click=on_click on:mouseenter=on_mouse_enter>
            {if id == "apple" {
                view! {
                    <span class="apple-logo" inner_html="<svg xmlns='http://www.w3.org/2000/svg' width='14' height='17' viewBox='0 0 14 17' fill='currentColor'><path d='M13.154 12.533c-.307.67-.665 1.284-1.075 1.846-.558.764-1.015 1.293-1.368 1.587-.546.481-1.131.727-1.757.742-.45 0-.992-.128-1.623-.388-.633-.258-1.214-.386-1.746-.386-.558 0-1.157.128-1.797.386-.641.26-1.159.395-1.554.41-.6.027-1.198-.227-1.794-.762-.382-.32-.859-.869-1.432-1.648-.614-.83-1.118-1.793-1.513-2.89C.165 10.302 0 9.19 0 8.116c0-1.236.267-2.302.802-3.195.42-.716.979-1.281 1.68-1.696.7-.415 1.457-.627 2.274-.642.477 0 1.103.148 1.882.438.776.291 1.275.439 1.495.439.164 0 .72-.173 1.666-.517.893-.32 1.647-.452 2.264-.4 1.673.135 2.93.794 3.768 1.981-1.496.907-2.236 2.176-2.22 3.805.014 1.27.475 2.326 1.38 3.167.41.39.869.691 1.378.904-.11.32-.228.628-.353.921l.038-.013zM10.088.417c0 .996-.364 1.926-1.09 2.787-.876 1.024-1.936 1.616-3.085 1.523a3.1 3.1 0 0 1-.023-.377c0-.956.417-1.98 1.157-2.816.37-.424.84-.776 1.41-1.058.568-.278 1.106-.432 1.611-.46.015.134.02.267.02.401z'/></svg>"></span>
                }.into_any()
            } else {
